      ...
      {(isSidebarOpen || isAnimating) && (
        ...
        >
          ...
          <div className="flex justify-center mt-2">
            <Link
              to="/"
              className="text-4xl font-bold text-[#FFD700] tracking-[1.08px] max-sm:text-3xl max-[400px]:text-2xl"
            >
              VASTRAAE
            </Link>
          </div>
          <div className="flex flex-col items-center gap-1 mt-7">
            <Link
              to="/"
              className="py-2 border-y border-primary w-full block flex justify-center"
            >
              Home
            </Link>
            <Link
