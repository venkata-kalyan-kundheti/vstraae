...
const Footer = () => {
  return (
    <>
      <SocialMediaFooter />
      <footer className="max-w-screen-2xl mx-auto border-b-8 border-primary px-5 max-[400px]:px-3">
        ...
        <div className="flex flex-col gap-8 my-20">
          ...
          <h2 className="text-6xl font-bold text-[#FFD700] text-center max-sm:text-5xl">VASTRAAE</h2>
